# """
# Step 6b: Verify Embedding Norm Distributions
...
# Output:
#     results/norms/{model_key}_norm_distributions.png
#     results/norms/{model_key}_norm_stats.json
# """
...
# RESULTS_DIR = PROJECT_ROOT / "results" / "norms"
...
# def main():
#     parser = argparse.ArgumentParser(description="Step 6b: Verify embedding norm distributions")
...
Usage:
    python scripts/step6b_verify_norms.py --model gemma2b
    python scripts/step6b_verify_norms.py --model gemma9b
    python scripts/step6b_verify_norms.py --model qwen3_4b
    python scripts/step6b_verify_norms.py --model all
